...
namespace LINQPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var titlesForProductsWithPricesInRange10To20OrderedByTitleAsc = products.Where(product => (product.Price >= 10.00 & product.Price <= 20.00)).OrderBy(product => product.Price);
